...
public class ScoreHelper {
    ...
    private ScoreHelper(Player player) {
        ...
        faction = scoreboard.getTeam("faction");
        faction.setPrefix(ChatColor.YELLOW + "");

        if (scoreboard.getTeam("ally") == null) {
            scoreboard.registerNewTeam("ally");
        }

        ally = scoreboard.getTeam("ally");
        ally.setPrefix(ChatColor.DARK_GREEN + "");
